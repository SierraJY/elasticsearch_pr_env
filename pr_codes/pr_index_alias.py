...
es.indices.update_aliases(body={"actions": [{"add": {"index": index_name, "alias": alias_name}}]})
...
es.indices.update_aliases(body={"actions": [{"remove": {"index": index_name, "alias": alias_name}}]})
